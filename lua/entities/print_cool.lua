...
if(hit:GetClass() == "bm_print_a" || hit:GetClass() == "bm_print_b" || hit:GetClass() == "bm_print_c")||hit:GetClass()== "bm_print_b_donator" ||hit:GetClass()== "bm_print_b_donator2" then
hit:SetNWFloat("proc_cooling",hit:GetNWFloat("proc_cooling")+ 25)
-- HERE
if ( hit:GetNWFloat( "proc_cooling", 110 ) < 0 ) then -- <- if 110 is max of the bar
